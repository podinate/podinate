...
func (s *DefaultApiService) ProjectGet(ctx context.Context, account string) (ImplResponse, error) {
	...
	//TODO: Uncomment the next line to return response Response(500, ProjectGet500Response{}) or use other options such as http.Ok ...
	//return Response(500, ProjectGet500Response{}), nil
