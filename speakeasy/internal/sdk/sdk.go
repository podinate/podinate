...
var ServerList = []string{
	// Production server
	"https://api.podinate.com/v0",
	// Development Server
	"http://localhost:3001/v0",
}
...
// SDK - Podinate API: The API for the simple containerisation solution Podinate.
type SDK struct {
	// Operations about accounts - accounts hold your resources and allow different users to have different permissions to them
	Account *Account
	// Operations related to your projects - projects are a distcint group of resources related to a single application or service
	Project *Project
	// Operations related to pods - Pods are a group of containers with the same lifecycle, and are the basic unit of deployment on Podinate
	Pod *Pod
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.195.2",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.195.2 0.0.1 podinate",
		},
	}
	...
	sdk.Pod = newPod(sdk.sdkConfiguration)
