...
// GetProjectProjectIDPodPodIDLogs - Get the logs for a pod
// Get the logs for a pod
func (s *Pod) GetProjectProjectIDPodPodIDLogs(ctx context.Context, request operations.GetProjectProjectIDPodPodIDLogsRequest, opts ...operations.Option) (*operations.GetProjectProjectIDPodPodIDLogsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/project/{project_id}/pod/{pod_id}/logs", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetProjectProjectIDPodPodIDLogsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
